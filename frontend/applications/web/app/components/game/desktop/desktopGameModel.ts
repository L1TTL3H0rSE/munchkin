...
export type DesktopStateFamily =
  | "lobby"
  | "setup"
  | "preparation"
  | "door-choice"
...
export function desktopStateFamily(projection: Projection): DesktopStateFamily {
...
export function desktopEncounterCards(projection: Projection): CardView[] {
  return uniqueCards([
...
export function desktopOpponentStatus(
...
export function desktopOpponentStatusLabel(
  status: ReturnType<typeof desktopOpponentStatus>,
): string {
  switch (status) {
    case "active":
      return "Ходит";
